...
class ImageCapture:
    ...
    def __init__(
        ...
        self._video_capture = cv2.VideoCapture(self._device_index, cv2.CAP_DSHOW)
    ...
    def start_recording(self):
        ...
        self._video_capture.open(self._device_index, cv2.CAP_DSHOW)
        if not self._video_capture.isOpened():
